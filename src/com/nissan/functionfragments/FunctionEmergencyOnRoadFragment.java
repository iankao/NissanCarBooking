...
public class FunctionEmergencyOnRoadFragment extends Fragment {

    String myPointsWebUrl = "http://nissan.iux.com.tw/appsvc/owners/services/sos";
    
    public FunctionEmergencyOnRoadFragment() {
    }
